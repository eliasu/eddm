    ...
    text_bard:
      -
        ...
        content:
          -
            type: text
            text: 'Wir suchen Wwoofer, Servicekraft und Luftsschloßbauer.'
      -
        type: set
        attrs:
          values:
